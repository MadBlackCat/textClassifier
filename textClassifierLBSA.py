...
# "First Party Collection", "Data Retention", "Cookies and Similar Technologies",
label_list =[ "First Party Use", "Links",
...
for label in label_list:
    ...
    predic_classes = np.argmax(hist_pre[0], axis=1)
...
pd.DataFrame(result).to_csv(eval_path, header="True")
