...
result = []
model_name = "RNN_"
eval_path = "./eval/"+ model_name  + "15.csv"
#
...
# result.append([label, precision_score(true_label, predic_classes), recall_score(true_label, predic_classes), f1_score(true_label, predic_classes)])
