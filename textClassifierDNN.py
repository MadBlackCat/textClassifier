...
# data_train = pd.read_csv('~/Testground/data/imdb/labeledTrainData.tsv', sep='\t')
    ...
    model.add(Dense(100, activation='relu', input_shape=(MAX_SEQUENCE_LENGTH,)))
    ...
    print("model fitting - DNN - " + classification_name)
    logging.info("model fitting - DNN - " + classification_name)
